...
public class Apartment {
    ...
    public Apartment(Integer id, String apartment_name, Integer apartment_id, Integer apartment_status, double price, double discount, String remark, Date create_date, Date update_date, Integer disabled) {
        this.id = id;
